...
import stylesCss from 'themes/privacydashboard/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_privacydashboard_componentCss']) {
    
    document['_vaadintheme_privacydashboard_componentCss'] = true;
  }
